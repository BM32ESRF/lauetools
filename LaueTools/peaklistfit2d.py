...
if 0:
    ...
    """
    myprocess = subprocess.Popen('fit2d -dim2048x2048 -com',
                                shell=True,
...
def fitpeak_f2d(filename, dirname='.', fit2ddirectory=None):
    ...
    if ext == 'mccd':
        ...
        xy_list = loadtxt("Ge_blanc_11Sep08_d1_5MPa_0000.peaks", usecols=(0, 1), skiprows=1)
    ...
    for i in range(nxy):
        ...
        myprocess = subprocess.Popen(' fit2d -dim2048x2048 -macfit2d_fitpeaks.mac ',
                                    shell=True,
                                    stdout=subprocess.PIPE,
                                    stdin=subprocess.PIPE,
                                    stderr=subprocess.STDOUT)

...
class spotsset:
    ...
    def AssignHKL(self, Orientation, grain_index, AngleTol=1.0,
        ...
        if not use_spots_in_currentselection:
            ...
            (index_r, tth_r, chi_r, _, _, intensity_r, _, _, _, _) = data_1grain.T
    ...
    def IndexSpotsSet(self, file_to_index, key_material, emin, emax, dict_parameters, database,
        ...
        while 1:
            ...
            while (((self.UBStack is not None) or (self.UBStack is not [None]))
                ...
                MatchRate, _, _ = self.AssignHKL(UB,
                                                            grain_index,
                                                            AngleTol=AngleTol_0,
...
#                                             verbose=verbose)
    ...
    def refineStrainElementsSpotsFamily(self, grain_index, initial_matrix,
                                                            getstrain=0, use_weights=1, verbose=0):
        r"""
    ...
    def plotgrains_alldata(self, titlefig="", unindexedspots=None, verbose=0):
        """ plot all Laue patterns of all grains
        """
                ...
                if imageindex >= nstart and GuessedUBMatrices is not 0:
                    ...
                    if GuessedUBMatrices is 0:  # TODO: to BE REMOVED
                        ...
                        previousResults = (nbAddMatrices, addMatrices,
                                            dictMR[lastindex][0], dictNB[lastindex][0])

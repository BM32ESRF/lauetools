...
#
#The summary files generated by FileSeries use the same Rlab and Rsample conventions as the summary files generated by multigrain.py 
#
...
#    print matstarlab_all.round(decimals=ndec)
    ...
    toto1 = column_stack((imgall[ind0[0]].round(decimals=1), xy_2spots[ind0[0],:].round(decimals=2), matstarlab_all.round(decimals=ndec)))
...
#def plot_diagr2(xy, hkl = None, plotmode = "firstplot", 
#                plotlabel = None, 
#                xmin0=0., xmax0=2048., ymin0 = 0., ymax0 = 2048., 
#                diagr = "top", xs = "cross",
#                add_label = None, add_label2 = None,
#                print_shortlist = "no"):
#
#
#    
...
#    if plotmode == "overlay" :
#        if xs == "cross" :
#            p.plot(xy[:,0],-xy[:,1],'rx', ms = 20, mew = 3)
#        else :
#            p.plot(xy[:,0],-xy[:,1],'o', ms = 16, mec = "r", mfc = "None", mew = 3)
#        
#    if hkl  is  not None :
#            hkl1 = np.array(hkl.round(decimals=1), dtype = int)
#
...
#          
#    elif diagr == "side" :
#        p.xlabel('xcam - upwards')
#        p.ylabel('-ycam - upstream')
#        xmin0 = -150.0
#        xmax0 = +150.0
#        ymin0 = -150.0
#        ymax0 = 150.0

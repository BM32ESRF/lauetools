...
if sys.version_info.major == 3:
    ...
    from . import cliques as Cli
    from . import ManualIndexFrame as MIF
    from . import MatrixEditor as MatEdit
else:
    ...
    import cliques as Cli
    import ManualIndexFrame as MIF
    import MatrixEditor as MatEdit
...
class LaueToolsGUImainframe(wx.Frame):
    ...
    def __init__(self, parent, _id, title, filename="",
        ...
        self.SetIcon(wx.Icon(os.path.join(projectfolder, "icons", "transmissionLaue_fcc_111.png"),
                wx.BITMAP_TYPE_PNG))
        ...
        self.CurrentdialogGrainCreation_cont = None
        self.SelectGrains_parametric = None

        self.indexation_parameters = None
        self.DataSet = None
        self.non_indexed_spots = None
    ...
    def OnCliquesFinding(self, _):
        ...
        # print('self.indexation_parameters', self.indexation_parameters)
        Cli.CliquesFindingBoard(self, -1, "Cliques Finding Board :%s" % self.DataPlot_filename,
    ...
    def OnEditMatrix(self, _):
        MatrixEditor = MatEdit.MatrixEditor_Dialog(self, -1,
                                                "Create/Read/Save/Load/Convert Orientation Matrix")

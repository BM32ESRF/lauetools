...
def peaksearch_skimage(filename, min_dist:int, pkid_threshold:int, bs:int, fit_peaks_gaussian, ccd_label:str, use_multiprocessing:bool=False):
    ...
    fit_peaks_gaussian= int(fit_peaks_gaussian)

...
myc,cor1,cor2 = GT.LaueSpotsCorrelator_multiprocessing(fileindexrange,imageindexref,
...
toldistance=.1
res = GT.getCommonSpots(filetoindex,fileauxiliary,toldistance, dirname=Parameters_dict['dirname'],
...
if 0:
    ...
    xkept, ykept, tab = GT.removeClosePoints_two_sets(pts.T, pts_black.T,
                                dist_tolerance=0.5,
                                verbose=1)

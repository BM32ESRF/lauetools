...
#                                            0.002, -0.0305, .987, 0.001, 1.005]
    ...
    print(FitO.error_function_strain(varying_parameters_values_array, varying_parameters_keys,
                                    Miller_indices,
                                    allparameters,
    ...
    FitO.fit_function_strain(varying_parameters_values_array, varying_parameters_keys,
                            Miller_indices,
                            allparameters,
                            absolutespotsindices, Xexp, Yexp,
...
#                                                 returnalldata=False)
    ...
    FitO.fit_function_latticeparameters(varying_parameters_values_array, varying_parameters_keys,
                                    miller_indices,
                                    allparameters,
                                    absolutespotsindices, pixX, pixY,
...
#     varying_parameters_values_array = [.2, -1.01, .3, 1.005, 0.1, 0.2, 0.01]
    ...
    FitO.error_function_general(varying_parameters_values_array, varying_parameters_keys,
                                        hkl,
                                        allparameters,
    ...
    FitO.fit_function_general(varying_parameters_values_array, varying_parameters_keys,
                                hkl,
                                allparameters,
                                absolutespotsindices, xyg1[:, 0], xyg1[:, 1],
                                UBmatrix_start=UB_raw,
...
#     starting_param = [0.9998, 1.0001, 0.001, -0.002, 0.001, -0.03, 0.01, 0.05, 1, 1.005, 0, 0, 0]
    ...
    res = FitO.error_function_on_demand_strain_2grains(g1strain + g1rot + g2strain,
                                        miller,
                                        allparameters,
    ...
    strain_sol = FitO.fit_on_demand_strain_2grains(np.array(starting_param),
                                miller,
                                allparameters,
    ...
    fit_results = FitO.error_function_on_demand_strain_2grains(strain_sol,
                                        miller,
                                        allparameters,
                                        arr_indexvaryingparameters,
                                        absolutespotsindices, pixX, pixY,
...
#     starting_param = [1, 1, 0, 0, 0, 0, 0, 0] + [1, 1.005, 0, 0, 0]
    ...
    #----------------------------------------------------------    
    res = FitO.error_function_on_demand_strain_2grains(g1strain + g1rot,
                                        miller,
                                        allparameters,
                                        arr_indexvaryingparameters,
                                        absolutespotsindices, pixX, pixY,

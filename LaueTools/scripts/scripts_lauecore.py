...
def test_simulation():
    ...
    return LT.CreateData_(oncam_sansh, outputname="tototable", pickledOK=0), oncam_sansh
...
if 0:
    ...
    LT.simulatepattern(grains, emin, emax, kf_direction, data_filename, Plot_Data=0)
    # -----------------------------------------------

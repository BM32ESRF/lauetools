...
import indexingAnglesLUT as IAL
...
def test_GetProximity():
    ...
    res = matchingrate.getProximity(TwicethetaChi, exp_theta, exp_chi,
...
def test_GetProximity2():
    ...
    simuldata = np.array([[  59.2164, -66.6041],[  54.7398, -88.3875],[  43.0763, -83.0983],[  58.895 , -88.7721],
       [  39.3337, -65.6132],[  52.4121, -58.2399],[  47.6515, -100.4466],[  47.9575, -83.2749],[  44.0163, -64.8536],
       [  56.4791, -57.2717],[  48.434 , -115.549 ],[  52.2976, -101.5099],[  28.9731, -75.0536],[  53.191 , -83.4718],
       [  49.0293, -64.0107],[  41.0373, -47.0408],[  52.3338, -117.1192],[  37.1386, -98.1813],[  58.7918, -83.6928],
       [  54.3839, -63.0704],[  55.9659, -41.1327],[  39.5682, -118.0816],[  56.3583, -118.8114],[  41.6482, -74.3025],
       [  49.9809, -43.6082],[  53.2592, -130.741 ], [  44.4802, -120.2579],[  49.9426, -100.9654],[  38.9334, -47.8105],
       [  54.7471, -41.6504],[  56.4465, -132.6251], [  49.6174, -122.6474],[  21.8155, -95.1273],[  57.3701, -73.2746],
       [  46.408 , -26.3132],[  55.4884, -25.5038],[  46.0081, -136.7264],[  59.6475, -134.6084],[  28.2351, -126.1327],
       [  54.9433, -125.2734],[  31.5495, -97.0398],[  22.4182, -53.4955],[  52.3414, -42.6513],[  36.0373, -24.6759],
       [  50.0743, -24.0159],[  58.489 , -23.5838],[  35.0685, -129.9977],[  43.26  , -99.4789],[  32.9485, -49.9361],
       [  40.7146, -21.6059],[  53.7612, -21.5865],[  32.8305, -146.1445],[  53.4871, -141.8828],[  42.2965, -134.3526],
       [  57.1994, -102.6829],[  45.4058, -45.3993],[  21.3158, -17.0592],[  45.4556, -18.3182],[  57.4384, -19.0229],
       [  37.2146, -149.6308],[  49.749 , -139.236 ],[  27.7533, -12.0696],[  50.1926, -14.8127],[  50.5507, -152.2943],
       [  41.5523, -153.2806],[  57.1871, -144.6661],[  34.2669, -6.6991],[  54.8492, -11.096 ],[  53.1766, -154.6529],
       [  45.7737, -157.0741],[  12.2809, -166.6089],[  40.6313, -1.0068],[  59.3447, -7.1823],[  52.0084, -4.6259],
       [  55.7231, -157.0654],[  49.8098, -160.985 ],[  22.0916, -176.2917],[  46.612 , 4.9165],[  43.6835, 1.9328],
       [  54.5417, -2.2204],[  42.4339, -165.4599],[  58.1746, -159.525 ],[  53.5979, -164.9811],[  30.6904, 174.3774],
       [  52.0051, 10.9533],[  56.9817, 0.2302],[  45.1098, -168.3128],[  26.5826, 178.968 ],[  57.086 , -169.0252],
       [  37.6256, 165.8261],[  15.6917, 39.6224],[  56.6694, 16.9722],[  32.5476, 15.6023],[  49.3926, 7.9288],
       [  59.3144, 2.7178],[  47.6427, -171.1734],[  42.8967, 158.285 ],[  22.5114, 46.4513],[  35.8165, 19.2694],
       [  50.0185, -174.0275],[  34.3748, 169.985 ],[  46.7627, 151.7992],[  27.9587, 52.2656],[  38.8316, 22.8625],
       [  54.4341, 13.9733],[  52.2268, -176.8611],[  49.55  , 146.2952],[  55.2312, 100.1347],[  32.2566, 57.1803],
       [  41.5781, 26.3568],
       [  54.2617, -179.6607],
       [  40.4564, 161.9228],
       [  51.5498, 141.6466],
    ...
    expdata = np.ascontiguousarray(np.array([[  45.44929 , -18.34126 ],[  45.157076, -137.083181],
       [  44.92114 , 154.84827 ], [  27.931473, 52.277335], [  35.129301, -129.958303],
       [  22.506704, 46.525391],[  45.805636, -157.105433], [  27.76149 , -12.146467],
       [  22.099332, -176.308319],[  21.854819, -95.128858]]), dtype=np.int32)
...
def test_indexation_with_apriori_Matrices():
    ...
    # READ .cor file
    mydata = IOLT.ReadASCIIfile(filename_data,
                        col_2theta=0,
                        col_chi=1,
                        col_Int=-1,
                        nblineskip=1)
...
#    indicespotmax=len(listofselectedpts)
    ...
    Tabledistance = GT.calculdist_from_thetachi(sorted_data[:, 0:2], sorted_data[:, 0:2])
    ...
    mama, hhh = IAL.getOrientMatrices(spot_index,
                        energymax,
...
#    Gstar_metric = CP.Gstar_from_directlatticeparams(a,b,c,alpha,beta,gamma)
    ...
    mat = IAL.matrices_from_onespot_new(spot_index, ang_tol,
                                table_angdist,
                                twiceTheta, Chi,
                                n, B,
                                verbose=1)
...
def example_angularresidues_np(ang_tol):
    ...
    AngRes = matchingrate.Angular_residues_np(test_Matrix, twicetheta_data, chi_data,
                    ang_tol=ang_tol,
                    key_material='CdTe',
                    emin=5, emax=40,

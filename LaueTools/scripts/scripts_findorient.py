...
#        hkl_all = CP.FilterHarmonics_2(hkl_all)
    ...
    FO.PlanePairs_from2sets(25.35, 5,
                            hkl1, hkl2, Gstar,
...
if 1:  # some tests to play with angles LUT
    ...
    pp, LUT = FO.PlanePairs_from2sets(12.58, 1.,
                                hkl1, hkl2, 'Cu',
                                onlyclosest=1, filterharmonics=1, verbose=1)
...
if 0:  # test of orient matrix from distorted unit cell
    ...
    mat = FO.OrientMatrix_from_2hkl(hkl1, coord1, hkl2, coord2, B, verbose='yes', frame='lauetools')

...
if __name__ == '__main__':
    ...
    if 1:
        ...
        LTHDF5.Add_allspotsSummary_from_fitfiles(Summary_HDF5_filename, 'UO2_20_90_serree_',
    ...
    if 0:
        ...
        Summary_HDF5_filename = 'jason.h5'
        LTHDF5.Add_allspotsSummary_from_fitfiles(Summary_HDF5_filename, 'UO2_20_90_serree_new_',
                                          '/home/micha/LaueProjects/UO2_raq1ter/fitfiles',
                                          [139, 140],
                                          Summary_HDF5_dirname='/home/micha/LaueProjects/UO2_raq1ter/fitfiles')
...
#                dirname_dictRes='/home/micha/LaueProjects/Ni_joint/fitfiles')
        dicos = LTHDF5.build_hdf5('B1ep6_carto2d_dict_0000_0081',
               dirname_dictRes='/home/micha/LaueProjects/Ni_joint/fitfiles')
...
#        tt.hdf.close()
    ...
    #    hdf5file = Tab.openFile("dictCu_3g.h5")
        ...
        mapdictname = {tableallspots:'tableallspots',
                         tableUB:'tableUB',
                         tableMR:'tableMR'}

...
#         wx.Dialog.__init__(self, parent, _id, title, size=(400, 250))
        ...
        wx.Frame.__init__(self, None, wx.ID_ANY, "Peak list plot properties",
                          size=(600, 400))
        ...
        self.expimagetxtctrl = wx.TextCtrl(self.panel, -1,
                                   '', size=(400, -1))
        self.expimagebrowsebtn = wx.Button(self.panel, -1,
                                   '...', size=(50, -1))
...
#         self.Fit()
    ...
    def refreshwholeGrid(self):
        ...
        for i in range(len(self.myDataList)):
            ...
            markercombo = wx.ComboBox(self.panel, -1, str(self.myDataList[i]['marker']),
...
#         setattr(self, 'namectrl_%d' % datalist_index, txtctrlname)
        ...
        markercombo = wx.ComboBox(self.panel, -1,
...
#             setattr(self, 'markercombo_%d' % datalist_index, markercombo)
    ...
    def onCheckBox(self, evt, chckindex):
        ...
        if newstate is False:
            ...
            self.plotmarkers(addscatteratindex=chckindex,
                     ...
                     edgecolor=self.convert_to_rgbmatplotlib(self.myDataList[chckindex]['Color']))
    ...
    def onChangeSize(self, evt, index):
        ...
        if self.scatterplot_list is not []:
            ...
            self.plotmarkers(addscatteratindex=index,
                     ...
                     edgecolor=self.convert_to_rgbmatplotlib(self.myDataList[index]['Color']),
                     markersize=newsize)
    ...
    def onChangeMarker(self, event, comboindex):
        ...
        if self.scatterplot_list is not []:
            ...
            self.plotmarkers(addscatteratindex=comboindex,
                     ...
                     edgecolor=self.convert_to_rgbmatplotlib(self.myDataList[comboindex]['Color']))
    ...
    def readnewpeaklistfile(self):
        ...
        if not os.path.isfile(fullpathfilename):
            dlg = wx.MessageDialog(self, 'peak list file : %s\n\ndoes not exist!!' % fullpathfilename,
...
#             print 'type filename', type(filename)
    ...
    def plotmarkers(self, addscatteratindex=None, markerstyle='o', edgecolor='g', markersize=20):
        ...
        kwords = {'marker':markerstyle, 'facecolor':'None', 'edgecolor':edgecolor, 's':markersize}
        ...
        self.myscatter = self.parent.axes.scatter(X - X_OFFSET, Y - Y_OFFSET,
                                                 alpha=1.,
                                                 **kwords)
